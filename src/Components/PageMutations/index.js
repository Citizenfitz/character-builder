...
const PageMutations = () => (
  <div className="newstyle">
    ...
    <ul>
      ...
      <li>
        If hit, suffers 3d4 damage, then 2d4 on the following round, and 1d4 on
        the third and final round.
      </li>
      <li>
        May make a saving throw each round to reduce the damage by half. Targets
        may stop the second and third rounds of damage by diving into water,
        applying an alkaline substance, etc.
      </li>
    </ul>
    ...
    <p>
      ...
      character. Alacrity lasts for 4 rounds plus the character's CON modifier.
    </p>
    ...
    <ul>
      ...
      <li>
        ...
        saving throw or be blinded for 1d4 rounds. This attack can be used once
        per hour.
      </li>
    </ul>
    <h2 id="chameleon-ability">Chameleon Ability</h2>
    <p>
      The character can alter their epidermis to blend perfectly into just about
      any environment. They gain +5 on all rolls involving concealing themselves
      when stationary and +3 if they are moving. <em>Chameleon Ability</em> will
      not work (or work much less effectively) if the character is wearing
      significant clothing, armor, etc.
    </p>
    <h2 id="clinging">Clinging</h2>
    <p>
      The character can cling to and transverse vertical surfaces like a lizard
      or insect. This ability functions exactly like the spell{" "}
      <em>Spider Climb</em> except it offers no protection against <em>Web</em>{" "}
      spells. Clinging cannot be used without bare hands and/or feet.
    </p>
    <h2 id="compressible-form">Compressible Form</h2>
    <p>The character is without a solid internal body structure and as such:</p>
    <ul>
      <li>Suffers -1 hp damage per die from all bludgeoning attacks</li>
      <li>
        Can squeeze/ooze through cracks as small as 3.5 inches in diameter or 1
        inch high by 1 foot wide. Such movement is considered twice-slowed (each
        1' of travel takes 4' of movement).
      </li>
      <li>
        Is almost impossible to restrain with chains, ropes, manacles, etc. and
        gains +7 to resist or escape all grab maneuvers.
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        <em>Advantage</em> on <strong>saving throws vs blinding attacks</strong>{" "}
        such as Bioluminescent (each d20 roll is for one head so it is possible
        one is blinded and not the other).
      </li>
      <li>
        <em>Disadvantage</em> on{" "}
        <strong>saving throws vs other gaze attacks</strong> (like
        petrification) where one head is likely to succumb to the attack even if
        the other avoids it.
      </li>
    </ul>
    <h2 id="dwarfism">Dwarfism</h2>
    <p>
      The character is much smaller than a normal human. Roll a d12 to determine
      their size:
    </p>
    <table>
      <thead>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            movement, +4 to all Stealth rolls, +1 AC vs ranged attacks. May not
            use weapon larger than dagger
          </td>
        </tr>
        <tr>
          <td className="ut-align-center">
          ...
          <td>
            ...
            movement, +5 to Stealth rolls, +2 AC vs ranged attacks. May not use
            weapon larger than knife
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <p>
      Character gains +2 to hearing perceptions rolls and can "see" in complete
      darkness at a range of 120'. Echolocation does not work around corners and
      can only perceive rough shapes, not colors, writing, or images on walls.
      Characters using echolocation emit a sound which is inaudible to normal
      hearing but may be detected by creatures with extraordinary hearing or
      with echolocation themselves.
    </p>
    <h2 id="electrogenic-attack">Electrogenic Attack</h2>
    <p>
      The character can discharge a powerful electric attack against anyone they
      are touching. The attack causes 1d8 points of damage and targets must make
      a CON-modified saving throw or be stunned for 1d4 rounds (unable to take
      actions and is attacked with advantage). Underwater electrogenic attacks
      inflict half the damage and stun time, but affects all creatures within 10
      feet of the character. This power can be used once every 5 minutes.
    </p>
    <h2 id="extra-arms">Extra Arms</h2>
    <p>
      The character possesses 1d6 extra arms. These arms may be humanoid or
      something else (tentacles, insectoid, etc.). These extra limbs provide the
      character:
    </p>
    <ul>
    ...
    <p>
      ...
      place on their body (mouth, hands, navel, etc.). This gas can be projected
      up to 30', fills a 20' area, and persists for 5 rounds (though high winds
      will disperse it immediately). Creatures within the cloud suffer effects
      identical to the spell <em>Stinking Cloud</em>. The character is immune to
      his or her own gas.
    </p>
    ...
    <p>
      ...
      horizontal movement is at the mercy of wind currents. He or she may carry
      aloft up to four times their body weight.
    </p>
    ...
    <p>
      ...
      ultra/subsonic sounds within 300 ft with a successful perception roll. The
      character has <em>Vulnerability</em> to sonic attacks and against them
      suffers:
    </p>
    <ul>
      <li>
    ...
    <p>
      The character has an incredible sense of smell. They gain advantage on all
      scent-related perception rolls and with a successful roll can perform such
      acts as:
    </p>
    <ul>
      <li>
      ...
      <li>
        Sense within 5 miles the general direction and distance of water, fresh
        animal carcass, large trash heap, etc.
      </li>
      <li>
        Detect whether food and water is safe to eat (not spoiled, poisonous,
        etc.) The character has <em>Vulnerability</em> to gas or inhaled attacks
        and against them suffers:
      </li>
      <li>
        <em>Disadvantage</em> on saving throws
      </li>
    ...
    <p>
      ...
      character possesses. <em>Metamorphosis</em> may only be initiated once per
      hour.
    </p>
    <h2 id="natural-armor">Natural Armor</h2>
    <p>
      The character is naturally armored (scales, carapace, thick fur, thick
      blubbery skin, bark, etc.) affording them an improved armor class. Roll d6
      to determine armoring:
    </p>
    <table>
      <thead>
        <tr>
    ...
    <ul>
      ...
      <li>
        Failing their save they are affected as if under a <em>Charm Person</em>{" "}
        spell.
      </li>
      <li>
        Making their save; are immune to the character's{" "}
        <em>pheromonic influence</em> for a week. Targets remaining in the 120'
        range are allowed additional saving throws to escape the effect as per{" "}
        <em>Charm Person</em>. Targets leaving the 120' range will automatically
        shake off the effects in four hours.
      </li>
    </ul>
    <h2 id="prehensile-tail">Prehensile Tail</h2>
    <p>
      The character has a prehensile tail that improves their balance and can be
      used for grasping objects or hanging from. Characters with prehensile tail
      gain +2 to their Dexterity attribute.
    </p>
    ...
    <p>
      ...
      damage with a successful Combat attack. Radiant Gaze may only be used once
      every 4 rounds.
    </p>
    <h2 id="regeneration">Regeneration</h2>
    <p>
      The character heals much faster than normal, regaining an additional hit
      die (of their class type) plus their CON bonus (ignore negatives) of lost
      hit points per day. Additionally, given time they can regrow lost
      extremities:
    </p>
    <ul>
      <li>
    ...
    <p>
      The character is highly resistant to a specific effect. They are immune to
      low-level instances of it so if resistant to cold they could withstand
      freezing temperatures while nude, if resistant to heat they could walk
      across a bed of hot coals without harm, etc. Against attacks based on the
      effect they:
    </p>
    <ul>
      <li>
      ...
      <li>
        Suffer ½ duration of any attack effects (paralysis, deafness, etc.) Roll
        d12 for type of resistance:
      </li>
    </ul>
    <table>
      <thead>
    ...
    <p>
      Thrice per day the character is able to emit a powerful sonic shriek that
      affects all creatures in a 50' cone in front of the character. The shriek
      inflicts 3d4 of damage and will shatter most glass or crystalline
      materials in the area affected. Furthermore, creatures within the area
      affected must make a CON-modified saving throw or be deafened and lose any
      echolocation abilities for 3d4 rounds.
    </p>
    <h2 id="spines-thorns-or-quills">Spines, Thorns, or Quills</h2>
    <p>The character is covered in spines, thorns, or quills affording them:</p>
    <ul>
      <li>A melee attack doing 1d4 damage</li>
      <li>
        Combat reaction attack at +4 to hit against any creature attacking them
        with: grab; grapple; touch-range effect; natural weapon (claws, fangs,
        etc.); or a melee weapon shorter than a short sword.
      </li>
    </ul>
    <h2 id="symbiotic-domination">Symbiotic Domination</h2>
    <p>
      The character may take over another living creature's motor functions via
      physical contact. The character must touch the target and the target is
      allowed a CON or WIS-modified saving throw to resist the effect.
    </p>
    <ul>
      <li>
    ...
    <p>
      ...
      dermal excretion, stinger, bite, etc. The character must successfully hit
      the target in combat and the target is allowed a saving throw to avoid the
      effect. Roll d8 to determine which type of venom the character possesses:
    </p>
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <br />
            affects target identically to a Ray of Enfeeblement spell for 1 hour
          </td>
        </tr>
        <tr>
          <td>
    ...
    <p>
      ...
      limited to a 10' radius. Additionally, the character can generate utility
      webbing as strong as a sturdy rope at will.
    </p>
    ...
    <p>
      ...
      the user can see, one they're familiar with, or specified with directions
      and distance (i.e. "20 feet down"). The user may bring along one other
      creature weighing no more than 500lb. Unwilling creatures are allowed a
      saving throw to avoid the effect. If a solid object occupies the
      destination the power fails and the user and any creature traveling with
      them suffer 4d6 points of damage.
    </p>
    <ul>
      <li>
        <b>x2 Stacking:</b> Range of 240' and can take up to two creatures 1000
        lbs or less
      </li>
      <li>
    ...
    <p>
      ...
      on creatures and magically summoned creatures (they're dismissed to whence
      they came), but not magic items. The caster may dispel:
    </p>
    <ul>
    ...
    <p>
      The character is incredibly aware and gains +3 to all perception rolls, is
      only surprised on a roll of 1 on d12, and makes such rolls without penalty
      even while distracted or asleep.
    </p>
  </div>
);
